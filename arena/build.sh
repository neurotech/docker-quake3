...
docker run -v /home/ioq3srv/.q3a -v /home/ioq3srv/.q3a/baseq3 -v /home/ioq3srv/.q3a/arena --name quake-data busybox
### ! Testing ! ###
docker cp ${HOME}/data/quake3/ioq3ded.x86 quake-data:/home/ioq3srv/.q3a/
